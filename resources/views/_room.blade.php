    ...
    <div class="container">
        <form action="{{route('roomStore')}}" method="post">
            ...
            <div class="mb-6">
                ...
                <input class="border border-gray-400 p-2 w-full" type="text" name="number" id="room_no"
            ...
            <div class="mb-6">
                ...
                <select class="border border-gray-400 p-2 w-full" name="type" id="room_type" required>
